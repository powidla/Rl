...
class CSP(search.Problem):
    ...
    def __init__(self, variables, domains, neighbors, constraints) -> object:
    ...
    def backtrack(assignment):
        ...
        for value in order_domain_values(var, assignment, csp):
            if 0 == csp.nconflicts(var, value, assignment):
                ...
                print("Checking assignment:", assignment)
                removals = csp.suppose(var, value)
                print("Doing inference:", csp.curr_domains)
                change = inference(csp, var, value, assignment, removals)
                if change: print("Domains modified:", csp.curr_domains)
